...
if __name__ == '__main__':
    ...
    if len(args.sampling.split('-')) > 10:
        ...
        log_filename = os.path.join(log_dir, f'test_{model_name}_{datasetname}_trainer{args.world_size}_bs{args.batch_size}_sl{fanout}x{sampling_len}_ep{args.epoch}_hd{args.hidden_size}_localFalse.log')
    else:
        log_filename = os.path.join(log_dir, f'test_{model_name}_{datasetname}_trainer{args.world_size}_bs{args.batch_size}_sl{args.sampling}_ep{args.epoch}_hd{args.hidden_size}_localFalse.log')
